...
export const en = {
  ...
  openOriginalMissing: "Original was not stored. Re-import with --preserve-raw.",
  openOriginalDesc: "Open the stored original with Mail or Preview.",
  ...
  noHits: "No hits",
  searchPreviewEmpty: "Select a hit",
