...
| What | Notes |
| --- | --- |
| Phase 2.4 | Epic [#360](https://github.com/nonamexishere/interlace/issues/360). **#361** person media gallery landed (PR **#381**). **#362** timeline media-kind filter **in flight**. Do not start 1.1 / Phase 3 / #80–#82 unprompted. |
