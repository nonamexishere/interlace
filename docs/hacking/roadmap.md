...
| What | Notes |
| --- | --- |
| Phase 2.3 | Epic [#264](https://github.com/nonamexishere/interlace/issues/264) / [milestone 8](https://github.com/nonamexishere/interlace/milestone/8) **closed**. Coding done (#265–#279 / #297 / #300 / #305 / #306, PRs #282–#301 / #323 / #324). **#303** / **#304** done. First notarized `app-v*` is not cut. Do not start 1.1 / P3 / P4. Ask before the first notarized `app-v*`. |
