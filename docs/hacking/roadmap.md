...
| What | Notes |
| --- | --- |
| Phase 2.3 | Epic [#264](https://github.com/nonamexishere/interlace/issues/264) / [milestone 8](https://github.com/nonamexishere/interlace/milestone/8) **closed**. Coding done. **#303–#310** done (PRs **#323–#332**). Next coding **#311** only if asked. Remaining parked dogfood **#311–#322** only if asked. First notarized `app-v*` is not cut. Do not start 1.1 / 3 / 4. Ask before the first notarized `app-v*`. |
