...
| What | Notes |
| --- | --- |
| Phase 2.4 | Epic [#360](https://github.com/nonamexishere/interlace/issues/360). **#361**–**#364** landed (PRs **#381**–**#383**, **#386**). **#384** compact filters and **#385** switcher + locale were tried and **backed out**. Do not start 1.1 / Phase 3 / #80–#82 unprompted. |
