...
| What | Notes |
| --- | --- |
| Phase 2.3 | Epic [#264](https://github.com/nonamexishere/interlace/issues/264) / [milestone 8](https://github.com/nonamexishere/interlace/milestone/8) **closed**. Coding done. **#303–#313** done (PRs **#323–#328**, **#330**, **#332**, **#336**, **#338**, **#340**). Next coding **#314** only if asked. Remaining parked dogfood **#314–#322** only if asked. First notarized `app-v*` is not cut. Do not start 1.1 / 3 / 4. Ask before the first notarized `app-v*`. |
