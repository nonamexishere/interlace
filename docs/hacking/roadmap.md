...
| What | Notes |
| --- | --- |
| Phase 2.4 | Epic [#360](https://github.com/nonamexishere/interlace/issues/360). **#361**–**#379**, **#400**, and **#402** landed (PRs **#381**–**#383**, **#386**, **#388**, **#390**, **#392**, **#394**, **#396**, **#398**, **#401**, **#404**, **#406**, **#408**, **#409**, **#410**, **#411**, **#412**; **#379** merged). **#380** (this branch) plays the next People-timeline voice note when one ends. **#384** compact filters and **#385** switcher + locale were tried and **backed out**. **#403** stays filed. Do not start 1.1 / Phase 3 / #80–#82 unprompted. |
