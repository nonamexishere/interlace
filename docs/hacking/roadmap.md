...
| What | Notes |
| --- | --- |
| Phase 2.3 | Epic [#264](https://github.com/nonamexishere/interlace/issues/264) / [milestone 8](https://github.com/nonamexishere/interlace/milestone/8) **closed**. Coding done. **#303–#322** done (PRs **#323–#328**, **#330**, **#332**, **#336**, **#338**, **#340**, **#343**, **#345**, **#347**, **#349**, **#351**, **#353**, **#355**, **#356**, **#357**). Next coding **#342** only if asked. Parked dogfood UI is empty unless Mustafa opens a new one. **#342** parked until picked. Line count is not a CI gate. First notarized `app-v*` is not cut. Do not start 1.1 / 3 / 4. Ask before the first notarized `app-v*`. |
