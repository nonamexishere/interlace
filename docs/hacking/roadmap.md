...
| What | Notes |
| --- | --- |
| Phase 4 | Epic [#56](https://github.com/nonamexishere/interlace/issues/56) **started**. **#79** is PR **#359** (`--preserve-raw`, default off). Next **#80** only if asked. #81 / #82 stay until picked. Do not start 1.1 / Phase 3 export unprompted. |
