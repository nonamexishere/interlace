...
HEAD on `master` is **#380** (next People-timeline voice note). This branch is **#403**: Search jump loads messages after the hit, not only older ones. **#378** (jump to a year from the inspector). **#377** (click a group participant to open that person). **#376** / PR **#412**,
**#375** / PR **#411**, **#374** / PR **#410**, **#372** / PR **#408**, and **#373** / PR **#409** landed.
**#361**–**#380**, **#400**, and **#402** landed. **#384** and **#385** were
tried and **backed out**. **#403** is this branch.
...
| #320 / PR #355 | Copy archive to… from Doctor and File (empty dest; dest Opens) |
...
| #364 / PR #386 | Gmail label chips under the mail subject (3 then `+k`; WhatsApp chip-less) |
| #365 / PR #388 | Search filter by Gmail label (closed select + Any; AND with other filters) |
| #366 / PR #390 | Person avatar from Contacts PHOTO (local CAS or two-letter initials) |
| #367 / PR #392 | Inspector rename + notes (not a merge; notes persist in SQLite) |
...
| #375 / PR #411 | Review queue keyboard map (j/k / a/r / Enter) |
| #376 / PR #412 | A–Z letter headings + present-letters rail |
| #377 | Click a group participant name to open that person |
| #378 | Jump to a year from the inspector |
| #379 | Lightbox next/prev walks photos across messages (this PR) |
...
**#403** (jump must load messages after the hit) is this branch.
...
helpers, files, and must-IDs. Orchestrator does not implement product
code.

### Suggested next

1. **#403** (this branch) loads messages after a Search jump, not only older ones. **#380** landed. **#384** / **#385** stay backed out.
...
1. #303–#322 / #342 / #361–#379 / #400 / #402 are done. Phase 2.4:
   **#384** / **#385** backed out. Stay at post-#380. **#403** is this branch (messages after a Search jump).
...
> epic #360 started: **#380** merged (#378 jump to a year from the inspector;
> #361–#379 / #400 / #402 landed). **#403** is this branch (messages after a Search jump). **#384** / **#385** stay backed out.
> Read
...
> #79 / PR #359 (CI green). Next Phase 4 coding #80 only if asked. #342 follow-up is D
> (quiet is correct).
> Line count is not a CI gate.
> Do not start 1.1 / Phase 3 export / #80–#82 unprompted.
