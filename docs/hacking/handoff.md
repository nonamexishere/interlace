...
HEAD when this was rewritten: `d5f9a9b` **Merge pull request #228** (#200
Lucide chrome icons). Tag **`app-v0.1.1`** is still the unsigned app. Epic
...
| # | Note |
| --- | --- |
| **#201** | Own Tooltip, Separator, Badge, Card. Next coding. |
...
1. Next coding: **#201** (Tooltip / Separator / Badge / Card). **#224** is
...
> `docs/design/UI-DESIGN.md`. Next coding is **#201** (owned primitives). Do not
