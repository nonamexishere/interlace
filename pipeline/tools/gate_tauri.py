...
#     fallback). Spacers / visibleRange / ensureTlIndexVisible use prefix
#     sums, not index * 88. Keep the #120 window. Not: 10M in one view,
#     lazy-decode every photo, live average fallback, #206/#207 changes.
"""
