...
def main() -> None:
    ...
    assert_jump_day_heading_review(crate)
    assert_jump_day_heading_freeze(crate)
    assert_jump_day_heading_stutter(crate)
    ...
    assert_timeline_attach_kind(crate)
    ...
    assert_switch_archive_err(crate)
