...
_SPLIT_MAIN_ASSERTS = (
    ...
    "assert_jump_day_heading_fold2",
    "assert_jump_day_heading_fold3",
    ...
    "assert_around_message",
    "assert_around_scroll",
    "assert_around_land",
    ...
    "assert_person_media_gallery_bind",
